...
import com.cimcitech.base_api_sdk.bean.BaseApiRequestBean;
 ...
 * Description: 接口请求实现类
 */
public class BaseApiRequestImpl implements BaseIF {
    private static final String TAG = "BaseApiRequestImpl";
     ...
     */
    public void startRequest(final OnBaseCallback callback, String url, final BaseApiRequestBean cimcRequestBean, final Class classOfT) {
        if (callback == null) {
            return;
        }
        ...
        String json;
        {
            json = CIMCCommonUtils.mGson.toJson(cimcRequestBean, BaseApiRequestBean.class).replace("\\n", "");
        }
